...
export default function Footer({ lang, d }: Props) {
  ...
  return (
    <footer style={{ background: "#F2E8D9", borderTop: "1px solid rgba(201,168,76,0.2)" }}>
      {/* Top section */}
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {/* Brand */}
        <div className="lg:col-span-2">
          <h2
            className="text-[#C9A84C] text-3xl font-bold mb-2"
          ...
          <div className="flex gap-4 mt-6">
            <a
              ...
              className="w-9 h-9 border border-[rgba(201,168,76,0.4)] flex items-center justify-center text-[#C9A84C] hover:bg-[#C9A84C] hover:text-white transition-all duration-200"
            >
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#6B5341] mb-5">
            ...
            <li className="flex justify-between gap-4">
              ...
              <span className="text-[#C9A84C] font-medium">{d.footer.hoursTime}</span>
            </li>
          </ul>
      ...
      {/* Bottom bar */}
      <div style={{ borderTop: "1px solid rgba(201,168,76,0.15)" }} className="py-5 px-5 md:px-8">
